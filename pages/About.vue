<template>
    <div class="about ">
        <div class="flex my-10 mx-10 p-10">
            <div class="flex flex-col w-2/6 my-auto" >
                <svg
              class="w-full"
            ...
            <div class="w-4/6 px-20">
                <p class=""> Amarachi Amaechi is a front end developer from Lagos, Nigeria, with a passion for acccessibility and great user experience.
                    she is also the organiser  of  <a href="https://twitter.com/VuejsNg"><span class="text-yellow-500">Vuejs Nigeria </span>Lead</a> where she holds monthly meetup for vuejs lovers in Nigeria.
                    I am also a technical writer and a . she loves contributing to OSS in her free time and is also an ardent speaker and writer .
                    When she’s not coding, you can find her Reading books, swimming and trying out new food recipes
                </p>
                    <h2 class="font-bold text-3xl py-4">Skills</h2>
                    <div>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">HTML5</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">CSS3</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">SASS/SCSS</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">Javascript</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">Vue.js</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">React.js</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">Nuxt.js</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">gridsome</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">Tailwind CSS</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">Boostrap</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">Netlify</button>
                    <button class="bg-gray-300 px-4 py-2 my-2 mr-2 rounded-xl hover:text-red-500">GIT/ GitHub</button>
                    </div>
                    <div class="mt-10">
                        <button class="bg-gray-300 px-4 py-2"><a href="/resume.pdf" target="_blank" rel="noopener" class="px-3 text-xl">Download CV</a><font-awesome-icon :icon="['fas', 'download']" style="color:red" /></button>
                    </div>
